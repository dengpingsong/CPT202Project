...
<template>
  <div class="layout" :class="{ collapsed }">
    <aside class="sidebar">
      ...
      <nav class="nav-group">
        <router-link to="/admin/projects" active-class="active">
        ...
        <router-link to="/admin/requests" active-class="active">
          <i class="bi bi-file-earmark-check nav-icon"></i>
          <span class="nav-label">Requests</span>
        </router-link>
        <router-link to="/admin/request-history" active-class="active">
        ...
        <router-link to="/admin/tags" active-class="active">

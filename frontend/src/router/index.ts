  ...
  routes: [
    ...
    // Student
    {
      ...
      children: [
        ...
        { path: 'projects', name: 'StudentProjects', component: () => import('../views/student/StudentProjectList.vue') },
        { path: 'projects/:id', name: 'StudentProjectDetail', component: () => import('../views/student/StudentProjectDetail.vue') },
        { path: 'history', name: 'StudentHistory', component: () => import('../views/student/StudentRequestHistory.vue') },
        { path: 'notifications', name: 'StudentNotifications', component: () => import('../views/student/StudentNotifications.vue') },
    ...
    // Teacher
    {
      ...
      children: [
        ...
        { path: 'settings', name: 'TeacherSettings', component: () => import('../views/teacher/TeacherSettings.vue') },
      ],
    },
    ...
    // Admin
    {
      ...
      children: [
        ...
        { path: 'projects', name: 'AdminProjects', component: () => import('../views/admin/AdminProjects.vue') },
        { path: 'users', name: 'AdminUsers', component: () => import('../views/admin/AdminUsers.vue') },
        { path: 'requests', name: 'AdminRequests', component: () => import('../views/admin/AdminRequests.vue') },
        { path: 'request-history', name: 'AdminRequestHistory', component: () => import('../views/admin/AdminRequestHistory.vue') },

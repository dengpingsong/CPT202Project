INSERT INTO users (user_id, username, password_hash, email, full_name, role, account_status, created_at, updated_at)
SELECT user_id, username, password_hash, email, full_name, role, account_status, created_at, updated_at
FROM (VALUES
...
) AS t(user_id, username, password_hash, email, full_name, role, account_status, created_at, updated_at)
WHERE NOT EXISTS (SELECT 1 FROM users WHERE user_id = 1001);

INSERT INTO teacher_profile (teacher_id, staff_no, department, title, research_area, office, updated_at)
SELECT teacher_id, staff_no, department, title, research_area, office, updated_at
FROM (VALUES
...
) AS t(teacher_id, staff_no, department, title, research_area, office, updated_at)
WHERE NOT EXISTS (SELECT 1 FROM teacher_profile WHERE teacher_id = 1002);

INSERT INTO student_profile (student_id, student_no, programme, enrollment_date, phone, interests, updated_at)
SELECT student_id, student_no, programme, enrollment_date, phone, interests, updated_at
FROM (VALUES
...
) AS t(student_id, student_no, programme, enrollment_date, phone, interests, updated_at)
WHERE NOT EXISTS (SELECT 1 FROM student_profile WHERE student_id = 1003);

INSERT INTO category (category_id, category_name, description, created_at, updated_at)
...
) AS t(category_id, category_name, description, created_at, updated_at)
WHERE NOT EXISTS (SELECT 1 FROM category WHERE category_id = 2001);

INSERT INTO tag (tag_id, tag_name, description, created_at, updated_at)
SELECT tag_id, tag_name, description, created_at, updated_at
FROM (VALUES
...
) AS t(tag_id, tag_name, description, created_at, updated_at)
WHERE NOT EXISTS (SELECT 1 FROM tag WHERE tag_id = 3001);

INSERT INTO project (project_id, teacher_id, category_id, title, description, required_skills, topic_area, max_students, current_agreed_count, project_status, publish_date, close_date, created_at, updated_at)
SELECT project_id, teacher_id, category_id, title, description, required_skills, topic_area, max_students, current_agreed_count, project_status, publish_date, close_date, created_at, updated_at
FROM (VALUES
...
) AS t(project_id, teacher_id, category_id, title, description, required_skills, topic_area, max_students, current_agreed_count, project_status, publish_date, close_date, created_at, updated_at)
WHERE NOT EXISTS (SELECT 1 FROM project WHERE project_id = 4001);
...
) AS t(project_id, tag_id)
WHERE NOT EXISTS (SELECT 1 FROM project_tag WHERE project_id = 4001 AND tag_id = 3001);

INSERT INTO project_request (request_id, project_id, student_id, reviewed_by, preference_rank, notes, request_status, decision_comment, submitted_at, reviewed_at, withdrawn_at, updated_at)
SELECT request_id, project_id, student_id, reviewed_by, preference_rank, notes, request_status, decision_comment, submitted_at, reviewed_at, withdrawn_at, updated_at
FROM (VALUES
...
) AS t(request_id, project_id, student_id, reviewed_by, preference_rank, notes, request_status, decision_comment, submitted_at, reviewed_at, withdrawn_at, updated_at)
WHERE NOT EXISTS (SELECT 1 FROM project_request WHERE request_id = 5001);

INSERT INTO request_status_history (history_id, request_id, old_status, new_status, changed_by, remark, changed_at)
SELECT history_id, request_id, old_status, new_status, changed_by, remark, changed_at
FROM (VALUES
...
) AS t(history_id, request_id, old_status, new_status, changed_by, remark, changed_at)
WHERE NOT EXISTS (SELECT 1 FROM request_status_history WHERE history_id = 6001);
